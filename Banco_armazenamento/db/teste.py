...
conexao = sqlite3.connect('Ema.db')
...
'''
"""
cursor.execute('CREATE TABLE IF NOT EXISTS Usuario(nome VARCHAR(40), senha VARCHAR(20), email VARCHAR(35), userName VARCHAR(15), id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT)')
